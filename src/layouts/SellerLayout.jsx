        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className={`fixed inset-y-0 left-0 w-64 bg-gray-800 transform ${
                ...
                <div className="flex items-center justify-center h-16 bg-gray-900">
                    <span className="text-white text-xl font-semibold">Seller Dashboard</span>
                </div>
                <nav className="mt-5 px-2 flex-1">
                    <Link
                        to="/seller"
                        className={`group flex items-center px-2 py-2 text-base font-medium rounded-md ${isActive('/seller')}`}
                    >
                    ...
                    <Link
                        to="/seller/mycars"
                        className={`group flex items-center px-2 py-2 text-base font-medium rounded-md ${isActive('/seller/mycars')}`}
                    >
                        <svg className="mr-4 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <Link
                        to="/seller/announcements"
                        onClick={handleAnnouncementClick}
                        className={`group flex items-center px-2 py-2 text-base font-medium rounded-md ${isActive('/seller/announcements')}`}
                    >
            ...
            {/* Main Content - Updated for better mobile layout */}
            <div className={`pr-0 lg:pl-0 ${isMobileMenuOpen ? 'ml-64' : 'ml-0'} transition-all duration-300`}>
                {/* Updated Top Navigation with Menu Button */}
                <div className="bg-white shadow">
                    <div className="px-4 py-4 flex justify-between items-center">
                        <div className="flex items-center gap-4">
                            <button
                                onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
                                className="lg:hidden p-2 rounded-md bg-gray-800 text-white hover:bg-gray-700"
                            >
                            ...
                            <h1 className="text-xl sm:text-2xl font-semibold text-gray-800">
                                {location.pathname === '/seller' && 'Seller Dashboard'}
                                {location.pathname === '/seller/mycars' && 'My Cars'}
                                {location.pathname === '/seller/announcements' && 'Announcements'}
                            </h1>
                        </div>
