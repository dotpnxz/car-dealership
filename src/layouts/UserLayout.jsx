        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className={`fixed inset-y-0 left-0 w-64 bg-gray-800 transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out z-40`}>
                <div className="flex items-center justify-center h-16 bg-gray-900">
                    <span className="text-white text-xl font-semibold">User Dashboard</span>
                </div>
                <nav className="mt-5 px-2 flex-1">
                    <Link
                        to="/buyer"
                        className={`group flex items-center px-2 py-2 text-base font-medium rounded-md ${isActive('/buyer')}`}
                    >
                    ...
                    <Link
                        to="/buyer/announcements"
                        onClick={handleAnnouncementClick}
                        className={`group flex items-center px-2 py-2 text-base font-medium rounded-md ${isActive('/buyer/announcements')}`}
                    >
                ...
                <div className="bg-white shadow">
                    <div className="px-4 py-3 flex justify-between items-center">
                        <h1 className="text-xl sm:text-2xl font-semibold text-gray-800">
                            ...
                            {location.pathname === '/buyer/announcements' && 'Announcements'}
                        </h1>
